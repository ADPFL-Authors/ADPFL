    ...
    def train(self):
        ...
        for round_idx in comm_round_iterable:
            ...
            for cur_clnt in client_indexes:
                ...
                w_per, training_flops, num_comm_params = client.train(
                    copy.deepcopy(w_global), round_idx
                )
        ...
        for clnt_idx in range(self.args.client_num_in_total):
            ...
            w_local_mdl, training_flops, num_comm_params = client.train(
                copy.deepcopy(w_local_mdl), -1
            )
