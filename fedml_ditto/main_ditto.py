...
def add_args(parser):
    ...
    parser.add_argument(
        "--epochs", type=int, default=2, metavar="EP", help="global training epochs"
    )
    ...
    parser.add_argument(
        "--comm_round", type=int, default=1000, help="total communication rounds"
    )
...
if __name__ == "__main__":
    ...
    args.identity = "dataset" + str(args.dataset)
