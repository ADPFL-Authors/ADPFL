...
from fedml_api.standalone.gossipfl.gossipfl_api import GossipFLAPI
from fedml_api.standalone.gossipfl.gossipfl_model_trainer import MyModelTrainer
...
def add_args(parser):
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="target sparsity for communication in gossipfl.",
    )
...
if __name__ == "__main__":
    ...
    args.identity = "gossipfl" + "-" + data_partition
    args.identity += "-sparsity" + str(args.target_sparsity)
    ...
    gossipflAPI = GossipFLAPI(dataset, device, args, model_trainer, logger)
    gossipflAPI.train()
